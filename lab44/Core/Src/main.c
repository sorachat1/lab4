...
void calpid()
{
	position = __HAL_TIM_GET_COUNTER(&htim2)*0.117;
...
{
	uint32_t currentDMAPointer = IC_BUFFER_SIZE - __HAL_DMA_GET_COUNTER((htim2.hdma[1])); // รู้ตำเเหน่งปัจจุบัน
